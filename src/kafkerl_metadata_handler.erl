...
%% Events
%%==============================================================================
-spec handle_sync_event(get_known_topics, any(), any(), state()) ->
  {reply, [kafkerl:topic()], any(), state()}.
...
%% Handlers
%%==============================================================================
-spec init([any()]) -> {ok, idle, state()} | {stop, bad_config}.
init([Config]) ->
...
-spec make_request([kafkerl_connector:address()], iodata(), integer()) -> ok.
